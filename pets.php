    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="pup.php"><button type="button" class="btn btn-outline-dark btn-edit">Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Pets+4+U/@19.015383,73.013583,15z/data=!4m2!3m1!1s0x0:0x29c61667de936a24?sa=X&ved=2ahUKEwjko5fEk9LtAhVIfSsKHb4bADMQ_BIwDXoECBYQBQ" target="_blank"><img src="images/pet/pets1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Pets 4 U">
                <input type="hidden" name="address" value="Shop No 1, Sparsh Chs, Plot No.101/102, Sector- 44, Seawoods, Navi Mumbai - 400706, Near SS High School">
                <input type="hidden" name="contact" value="8308702823">
            </form>
        </div>
