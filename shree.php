    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="vis.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Shree+Ashapura+General+Store/@19.033872,73.021307,15z/data=!4m2!3m1!1s0x0:0x2b1004ffe16c901e?sa=X&ved=2ahUKEwiS-pHgipntAhVCyDgGHVOeAFsQ_BIwCnoECBEQAw" target="_blank"><img src="images/grocery/grocery.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="rel.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Shree Ashapura General and Grocery Store">
                <input type="hidden" name="address" value="Shop No 6, Twins Tower, Sector 17, Nerul, Navi Mumbai - 400706, Near Meena Tai Hospital">
                <input type="hidden" name="contact" value="2227705213">
            </form>
        </div>
