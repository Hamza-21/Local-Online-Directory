    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="natur.php"><button type="button" class="btn btn-outline-dark btn-edit">Previous</button></a>
            </div>
            <div class="column">
                <a href = "https://www.google.com/maps/place/Havmor+Havfunn+Ice+Cream+Parlour/@19.0250584,73.0209876,15z/data=!4m2!3m1!1s0x0:0x4f8800af118fbfb9?sa=X&ved=2ahUKEwj5m-fbj9LtAhX1zjgGHbUQBvAQ_BIwEXoECCEQBQ" target="_blank"><img src="images/ice/havmor1.jpg" alt="No Image available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="kraft.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Havmor Ice Cream">
                <input type="hidden" name="address" value="Shop 10, Mahavir Niwas, Plot 301, Sector 21, Nerul, Navi Mumbai - 400706, Near Seawoods Darawe Station , Navi Mumbai , Opposite Haware Centurion Mall">
                <input type="hidden" name="contact" value="9820085098">
            </form>
        </div>
