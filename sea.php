    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="aish.php"><button type="button" class="btn btn-outline-dark btn-edit">Previous</button></a>
            </div>
            <div class="column">
                <a href = "https://www.google.com/maps/place/Seasons+Hotel-+Nerul/@19.0345535,73.0289866,15z/data=!4m8!3m7!1s0x0:0xc2c3fd020ba15358!5m2!4m1!1i2!8m2!3d19.0345535!4d73.0289866" target="_blank"><img src="images/hotels/sea1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Seasons Hotel">
                <input type="hidden" name="address" value="Plot No.45, Sector -13, D.Y.Patil Stadium Road, Nerul, Navi Mumbai, Maharashtra 400706">
                <input type="hidden" name="contact" value="7977345614">
            </form>
        </div> 
