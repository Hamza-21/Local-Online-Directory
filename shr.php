    ...
    <div class="container-fluid">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Shree Women Clinic Gynaecology">
                <input type="hidden" name="address" value="Shree womens clinic, shop no.1, shree Radhakrishna society, plot no.33, sector 42A, Seawoods, near seawoods bus stop,Nerul-400706, Landmark: namitas gym, Navi Mumbai">
                <input type="hidden" name="contact" value="4448134870">
            </form>
        </div>
