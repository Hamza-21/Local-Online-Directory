...
<!-- Navigation Bar -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/HP+Petrol+Pump+-+Gian+Automobile/@19.02403,73.02188,15z/data=!4m2!3m1!1s0x0:0xfba6611b42c7829?sa=X&ved=2ahUKEwji16r32cXtAhXbyDgGHUSfAakQ_BIwE3oECBsQBQ" target="_blank"><img src="images/petrol/gyan1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="sai1.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Gyan Automobiles">
                <input type="hidden" name="address" value="Plot No 15 Sector 25, Nerul, Navi Mumbai - 400706">
                <input type="hidden" name="contact" value="9833041119">
            </form>
        </div>
