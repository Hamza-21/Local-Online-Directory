...
<!-- Navigation Bar -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Hindustan+Petroleum/@19.013281,73.013447,15z/data=!4m5!3m4!1s0x0:0xc57da76e8f394d60!8m2!3d19.013281!4d73.013447" target="_blank"><img src="images/petrol/hp1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Hp Petrol Pump">
                <input type="hidden" name="address" value="Plot No.2, Seawoods West, Sector 44, Nerul, Navi Mumbai, Maharashtra 400706">
                <input type="hidden" name="contact" value="9821898890">
            </form>
        </div>
