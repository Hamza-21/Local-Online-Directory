    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="well.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Ashirvad+Medical+Stores/@19.0343584,73.009542,15z/data=!4m8!1m2!2m1!1sdy+patil+pharmacy+shop+nerul!3m4!1s0x0:0xbb8e337f10eb84be!8m2!3d19.0408265!4d73.0229178" target="_blank"><img src="images/pharmacy/dy1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="ada.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="DY Patil Pharmacy">
                <input type="hidden" name="address" value="C/O Dr Dy Patil Hospital, Nerul, Navi Mumbai - 400706, Sector 5">
                <input type="hidden" name="contact" value="8605011508">
            </form>
        </div>
