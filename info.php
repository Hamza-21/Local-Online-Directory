...
<!-- Navigation Bar -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Healthspring+Nerul/@19.0424416,73.0096493,15z/data=!4m5!3m4!1s0x0:0xdc94bf36922487c4!8m2!3d19.0424416!4d73.0096493" target="_blank"><img src="images/clinic/spring1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="apollo.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Healthspring Clinic">
                <input type="hidden" name="address" value="Shop Number 20, Ground Floor, Meredien Apartments, Sector 6, Landmark: Near Direct2u Grocery Store, Navi Mumbai">
                <input type="hidden" name="contact" value="8045688433">
            </form>
        </div>
