    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="a1.php"><button type="button" class="btn btn-outline-dark btn-edit">Previous</button></a>
            </div>
            <div class="column">
                <a href = "https://www.google.com/maps/place/The+Frosty+Cream/@19.0111882,73.0120317,15z/data=!4m5!3m4!1s0x0:0x4d69a6e2975124e7!8m2!3d19.0111882!4d73.0120317" target="_blank"><img src="images/ice/frost1.webp" alt="No Image available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="brain.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="The Frosty Cream">
                <input type="hidden" name="address" value="Shop 25, Shreeji Heights, Seawoods Sector 46a, Navi Mumbai - 400706, Plot No 1 A, B, C">
                <input type="hidden" name="contact" value="7208284000">
            </form>
        </div>
