...
<!-- Navigation Bar -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column text-center">
                <a href="https://www.justdial.com/Mumbai/Vishwas-General-Store-Near-Bus-Depot-Nerul/022PXX22-XX22-141103180250-R1R8_BZDET" target="_blank"><img src="images/grocery/grocery.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Vishwas General and Grocery Store">
                <input type="hidden" name="address" value="F-2, Darshan Apartment, Sector-20, Nerul, Navi Mumbai - 400706, Near Bus Depot">
                <input type="hidden" name="contact" value="2227755013">
            </form>
        </div>
