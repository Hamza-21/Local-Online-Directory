    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="drak.php"><button type="button" class="btn btn-outline-dark btn-edit">Previous</button></a>
            </div>
            <div class="column">
                <a href = "https://www.google.com/maps/place/Swastik+Hardware/@19.0342059,73.0199095,15z/data=!4m5!3m4!1s0x0:0x1bc51328ed970556!8m2!3d19.0342059!4d73.0199095" target="_blank"><img src="images/hardware/swas1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="shiv.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Swastik Hardware">
                <input type="hidden" name="address" value="F2 Shopping Center Shop No 13, Nerul Station Road, Nerul, Navi Mumbai - 400706, Opposite Nerul Station">
                <input type="hidden" name="contact" value="8976350032">
            </form>
        </div>
