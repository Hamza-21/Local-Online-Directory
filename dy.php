...
<?php include 'navbar.php'; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/D+Y+Patil+Hospital/@19.0411561,73.0246854,15z/data=!4m5!3m4!1s0x0:0xa446b85191e625c8!8m2!3d19.0411561!4d73.0246854?hl=en" target="_blank"><img src="images/gynae/dy1.jpeg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="tulsi.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="D Y Patil Healthcare Gynaecologist">
                <input type="hidden" name="address" value="DY Patil Healthcare D-wing, Sector-5,Nerul, Navi Mumbai">
                <input type="hidden" name="contact" value="2071172714">
            </form>
        </div>

        <div>
            <a href="gynae.php"><button type="button" class="btn btn-success">
            &larr; Back to Gynaecologists</button></a>
        </div>
