...
<!-- Navigation Bar -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column text-center">
                <a href="exception.php" target="_blank"><img src="images/pharmacy/data1.webp" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Shri Dattakripa Pharmacy">
                <input type="hidden" name="address" value="Plot No 8/3, Nerul, Navi Mumbai - 400706, Sector 8">
                <input type="hidden" name="contact" value="2227725102">
            </form>
        </div>
