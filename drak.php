    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="sel.php"><button type="button" class="btn btn-outline-dark btn-edit">Previous</button></a>
            </div>
            <div class="column">
                <a href = "https://www.google.com/maps/place/Draksha+Park/@19.041668,73.014592,15z/data=!4m2!3m1!1s0x0:0xadecd0d8a78f61f6?sa=X&ved=2ahUKEwjdpu-S_NHtAhUoyzgGHS1SBkUQ_BIwE3oECB8QBQ" target="_blank"><img src="images/hardware/drak12.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="swas.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Draksha Park Hardware">
                <input type="hidden" name="address" value="1& 2, Durga, Plot No 44, Sarsole Village, Phase II, Sector-06, Nerul, Navi Mumbai - 400706, Nr. Bikaner">
                <input type="hidden" name="contact" value="9022723532">
            </form>
        </div> 
