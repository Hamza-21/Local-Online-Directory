    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="saw.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Dr.+Sanjeevkumar+Kalkekar,+Cardiologist+Navi+Mumbai/@19.0116619,73.0145279,15z/data=!4m5!3m4!1s0x0:0xfcb0b5b075ac0efb!8m2!3d19.0116619!4d73.0145279" target="_blank"><img src="images/pedia/shru1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="jack.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Dr. Shruti Kalkekar Paediatrician">
                <input type="hidden" name="address" value="Shop no - 5, New Horizon CHS, Plot no. 1,2 & 3, near Navratna Restaurant, Sector 46, Seawoods, Navi Mumbai, Maharashtra 400706">
                <input type="hidden" name="contact" value="9769842515">
            </form>
        </div>
