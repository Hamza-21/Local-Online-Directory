...
<?php include 'navbar.php'; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Dr.+Sawant+Clinic+(Pediatrician)/@19.0308866,73.0221165,15z/data=!4m5!3m4!1s0x0:0x29a1877e38272236!8m2!3d19.0308866!4d73.0221165" target="_blank"><img src="images/pedia/pedia.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="shru.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Dr. Sawant Clinic Pediatricians">
                <input type="hidden" name="address" value="10, Kamlabai Birasdar Marg, Nerul East, Sector 21, Nerul, Navi Mumbai, Maharashtra 400706">
                <input type="hidden" name="contact" value="2227722256">
            </form>
        </div>
