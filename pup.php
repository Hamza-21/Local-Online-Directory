    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="yes.php"><button type="button" class="btn btn-outline-dark btn-edit">Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Dogs+'N'+Pups+%7C+The+Pet+Shop+-+Nerul/@19.0437042,73.0118205,15z/data=!4m5!3m4!1s0x0:0x305997fdb8ceab8d!8m2!3d19.0437042!4d73.0118205" target="_blank"><img src="images/pet/pup1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="pets.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Dogs N Pups">
                <input type="hidden" name="address" value="Shop No 2, Paradise Palace, Palm Beach Road, Sector 6, Nerul, Navi Mumbai - 400706, Opp SBI Bank">
                <input type="hidden" name="contact" value="7947170905">
            </form>
        </div> 
