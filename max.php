    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="cine.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Max+Movies/@19.0321908,73.0250312,15z/data=!4m2!3m1!1s0x0:0x2c583e7d7bf141fd?sa=X&ved=2ahUKEwjUu6nIgtLtAhWfxTgGHQ4YBrcQ_BIwDnoECBgQBQ" target="_blank"><img src="images/cinema/max1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="inox.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Max Movie Cinema">
                <input type="hidden" name="address" value="Haware Centurion Mall, Plot No 88/291, Ground Floor, Shop G-26, Nerul, Navi Mumbai - 400706, Near Sector No 19A">
                <input type="hidden" name="contact" value="2227717079">
            </form>
        </div>
