    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="sud.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Dr+Gaikwad+Child+Health+Care/@19.0411409,73.0148202,15z/data=!4m2!3m1!1s0x0:0x12c4bec0373557d7?sa=X&ved=2ahUKEwj4sZ7G_pjtAhVIwjgGHXbPArQQ_BIwCnoECBQQAw" target="_blank"><img src="images/pedia/child1.webp" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Child Health Centre Pediatrician">
                <input type="hidden" name="address" value="Sai Prasad, Shopping Complex, Plot Number 17, Sector Number 8., Landmark: Near Sahkar Baza, Navi Mumbai">
                <input type="hidden" name="contact" value="2071177328">
            </form>
        </div>
