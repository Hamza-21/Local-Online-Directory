    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="dmart.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Krishna Grocery Stores">
                <input type="hidden" name="address" value="Shop No. 1, 2 Sector 06 Plot 187, Palm Bridge, Nerul Sector 6, Navi Mumbai - 400706, Julelal Temple">
                <input type="hidden" name="contact" value="7666889298">
            </form>
        </div>
