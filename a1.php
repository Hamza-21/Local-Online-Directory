    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="kraft.php"><button type="button" class="btn btn-outline-dark btn-edit">Previous</button></a>
            </div>
            <div class="column">
                <a href = "https://www.google.com/maps/place/A1+Juice+Center/@19.0339207,73.0179376,15z/data=!4m5!3m4!1s0x0:0xa6850acf9b62ab62!8m2!3d19.0375617!4d73.020019" target="_blank"><img src="images/ice/a1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="frost.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="A1 Ice Cream And Juice Centre">
                <input type="hidden" name="address" value="Shivkrupa Apartment, Building No 3, Nl 4, Shop No 2, Sector 11, Nerul, Navi Mumbai - 400706, Near Shivsena Shakha">
                <input type="hidden" name="contact" value="9867275107">
            </form>
        </div>
