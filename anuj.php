    ...
    <div class="container-fluid">
        <!-- <div class="box">
         ...
         <div class="row">
            ...
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Anuj+Automobile/@18.9836684,73.1132279,15z/data=!4m2!3m1!1s0x0:0xf559b79e5b00633a?sa=X&ved=2ahUKEwjC-YXQ2cXtAhUIxTgGHcFZDeIQ_BIwE3oECB8QBQ" target="_blank"><img src="images/petrol/petrol.png" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Anuj Auto petrol pump">
                <input type="hidden" name="address" value="Plot No 45, Nerul, Navi Mumbai - 400706, Near Sector 13">
                <input type="hidden" name="contact" value="2227708012">
            </form>
        </div>
