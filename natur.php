...
<!-- Navigation Bar -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column">
                <a href = "https://www.google.com/maps/place/Natural+Ice+Cream/@19.0203159,73.018111,15z/data=!4m2!3m1!1s0x0:0x303ba503c44036cc?sa=X&ved=2ahUKEwjBlqe5j9LtAhXlH7cAHYbMB7EQ_BIwE3oECCQQBQ" target="_blank"><img src="images/ice/natur1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="havmor.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Natural Ice Cream Parlour">
                <input type="hidden" name="address" value="Shop No.19, Lakshmi Tower Co Operative Housig Society, Plot No 7, Seawoods, Navi Mumbai - 400706, Near Sector 42, Opposite Seawood Station">
                <input type="hidden" name="contact" value="8767931272">
            </form>
        </div>
