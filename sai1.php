    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="gyan.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/OM+Sai+Petroleum+Petrol+pump/@19.020257,73.028477,15z/data=!4m2!3m1!1s0x0:0xb3678a4c049975e3?sa=X&ved=2ahUKEwiftIyz2sXtAhWCwzgGHcPGDBIQ_BIwDHoECBUQBQ" target="_blank"><img src="images/petrol/sai.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="hp.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Om Sai Petroleum">
                <input type="hidden" name="address" value="Plot No 14, Uran Phata Road, Cbd Belapur, Navi Mumbai - 400614, Sector 21">
                <input type="hidden" name="contact" value="2227520265">
            </form>
        </div>
