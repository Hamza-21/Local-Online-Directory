    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="shu.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
            ...
            <div class="column text-center">
                <a href="child.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Dr. Anand Sude Pediatrician">
                <input type="hidden" name="address" value="Plot no. 27, Ganesh Mandir Marg, Sector 24, Juinagar, Navi Mumbai, Maharashtra 400705">
                <input type="hidden" name="contact" value="8108199861">
            </form>
        </div>
