...
<?php include 'navbar.php'; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Motherhood+Hospital+-+Kharghar,+Navi+Mumbai/@19.0357324,73.0632202,15z/data=!4m5!3m4!1s0x0:0x73fab948d50aaf4c!8m2!3d19.0357324!4d73.0632202" target="_blank"><img src="images/gynae/moth.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Motherhood Hospital Gynaecology">
                <input type="hidden" name="address" value="Motherhood Hospital, Fountain Square Building, Sector 7, Kharghar, Navi Mumbai, Maharashtra 410210">
                <input type="hidden" name="contact" value="2048556477">
            </form>
        </div>
