    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="jack.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Dr.Shirodkar's+Subhashish+Children+Clinic/@19.0352415,73.012172,15z/data=!4m2!3m1!1s0x0:0x7ad8458a92bfda59?sa=X&ved=2ahUKEwiGtev-_JjtAhXlyzgGHcYqAjsQ_BIwE3oECBMQBQ" target="_blank"><img src="images/pedia/shu1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="sud.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Shubhashish Children's Clinic">
                <input type="hidden" name="address" value="201, Shankar Changu Kanha Thakur Marg, Sector 20, Shankar Changu Kanha Thakur Marg, Sector 20, Nerul, Navi Mumbai, Maharashtra 400706">
                <input type="hidden" name="contact" value="7208161798">
            </form>
        </div>
