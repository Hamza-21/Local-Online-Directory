    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="dy.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Tulsi+Maternity+%26+Gynaecology+Clinic/@19.0200873,73.0165129,15z/data=!4m5!3m4!1s0x0:0x85b7becf167214b4!8m2!3d19.0200873!4d73.0165129" target="_blank"><img src="images/gynae/tulsi1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="shr.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Tulsi Maternity & Gynaecology Clinic">
                <input type="hidden" name="address" value="Shop Number 2, Shreeji Darshan CHS, Plot Number 48/49, Sector -40, Landmark: Seawoods Grand Central Mall, Navi Mumbai">
                <input type="hidden" name="contact" value="8879996122">
            </form>
        </div>
