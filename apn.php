...
<!-- Navigation Bar -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Apna+Bazar/@19.0415686,73.0095009,15z/data=!4m5!3m4!1s0x0:0xd276fe0aee936535!8m2!3d19.0415686!4d73.0095009" target="_blank"><img src="images/grocery/apn1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Apna Bazar Grocery Store">
                <input type="hidden" name="address" value="Plot no. 25/27, Shop No. 1 to 9, Meridian Apartments, Sector 6 Nerul Rd, Nerul, Navi Mumbai, Maharashtra 400706">
                <input type="hidden" name="contact" value="7506999230">
            </form>
        </div>
