...
<!-- Navigation Bar -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Apeejay+School+(Nerul)+-+Navi+Mumbai/@19.035376,73.021064,15z/data=!4m2!3m1!1s0x0:0x1361c939173c9106?sa=X&ved=2ahUKEwjP3K_Ai9LtAhUUyDgGHTAzDckQ_BIwHHoECC8QBQ" target="_blank"><img src="images/schools/apj1.jpeg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="dps.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Apeejay School">
                <input type="hidden" name="address" value="Nerul, Navi Mumbai - 400706, Near Nerul Railway Station, Opposite Jain Temple, Sector No 15">
                <input type="hidden" name="contact" value="2227703635">
            </form>
        </div>
