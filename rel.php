    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="shree.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Reliance+Fresh/@19.0388799,73.025881,15z/data=!4m5!3m4!1s0x0:0x88ff25340f075acc!8m2!3d19.0388799!4d73.025881" target="_blank"><img src="images/grocery/rel1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="apn.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Reliance Fresh Grocery Store">
                <input type="hidden" name="address" value="Plot No - 06 & 07, Sant Jnaneshwar Mauli Marg, Dr D Y Patil Vidyanagar, Nerul East, Sector 5, Nerul, Navi Mumbai, Maharashtra 400706">
                <input type="hidden" name="contact" value="2227727882">
            </form>
        </div>
