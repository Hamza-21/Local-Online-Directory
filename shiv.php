    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="swas.php"><button type="button" class="btn btn-outline-dark btn-edit">Previous</button></a>
            </div>
            <div class="column">
                <a href = "https://www.google.com/maps/place/Shivam+Electric+%26+Hardware/@19.0341406,73.0198696,15z/data=!4m2!3m1!1s0x0:0xbbbb3bfe84e02600?sa=X&ved=2ahUKEwjBsoPM_tHtAhXRwjgGHb4hB_UQ_BIwCnoECBAQBQ" target="_blank"><img src="images/hardware/shiv1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="vard.php"><button type="button" class="btn btn-outline-dark btn-edit">Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Shivam Electrical & Hardware Store">
                <input type="hidden" name="address" value="Shop No 14 F/2, Akarshan Apartment, Sector 15, Nerul, Navi Mumbai - 400706, Near Nerul Railway Station, Sector 15">
                <input type="hidden" name="contact" value="9819756581">
            </form>
        </div>
