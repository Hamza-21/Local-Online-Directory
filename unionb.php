...
<!-- Navigation Bar -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Union+Bank+of+India+Nerul/@19.033484,73.0175785,15z/data=!4m5!3m4!1s0x0:0x6581aac9103ce525!8m2!3d19.033484!4d73.0175785" target="_blank"><img src="images/banks/bank.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Union Bank Of India">
                <input type="hidden" name="address" value="F 009, Commercial Complex, Nerul, Navi Mumbai - 400706, Nerul Railway Station">
                <input type="hidden" name="contact" value="2227716317">
            </form>
        </div>
