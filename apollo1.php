    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="column text-center">
                <a href="moth.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Previous</button></a>
            </div>
            <div class="column text-center">
                <a href="https://www.google.com/maps/place/Apollo+Hospitals/@19.0205055,73.0289405,15z/data=!4m5!3m4!1s0x0:0xa0fac0993993ee7c!8m2!3d19.0205055!4d73.0289405?hl=en" target="_blank"><img src="images/gynae/apollo1.jpg" alt="No Image Available" class="center img-fluid"></a>
            </div>
            <div class="column text-center">
                <a href="terna.php"><button type="button" class="btn btn-outline-dark btn-edit">
                Next</button></a>
            </div>
        </div>
        ...
        <div class="text-center" style="margin-bottom: 10px;">
            <form action="fav_insert.php" method="POST">
                ...
                <input type="hidden" name="place" value="Apollo Hospitals Gynaecology">
                <input type="hidden" name="address" value="Plot Number 13, Parsik Hill Road, Off Uran Road, Sector 23, CBD Belapur Landmark: Opposite Nerul Wonders Park Belapur, Navi Mumbai">
                <input type="hidden" name="contact" value="2071185428">
            </form>
        </div> 
